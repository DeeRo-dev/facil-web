      ...
      <div className="w-5/6 flex flex-col items-center gap-10">
        ...
        <div className="w-4/6 text-colorText flex flex-col items-center mt-8 md:mt-0">
          ...
          <p className="text-lg font-normal text-center">
            ...
            respaldo que necesitas para disfrutar al máximo. Nuestra dedicación
            es garantizarte una experiencia de viaje excepcional, con vehículos
            de calidad y servicio al cliente de primera clase.
            <br />
            <br />
            Con Facil, tu aventura comienza desde el momento en que pisas
            nuestras sucursales. ¡Prepárate para descubrir Argentina con
            comodidad, confianza y la garantía de una experiencia inolvidable
            junto a nosotros!
          </p>
        </div>
        ...
        <div className=" w-full items-center flex flex-col gap-5">
          <div>
            ...
            <p className="text-sm font-normal text-center text-colorText">
